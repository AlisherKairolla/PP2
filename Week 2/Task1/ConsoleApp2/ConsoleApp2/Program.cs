...
namespace ConsoleApp2
{
    class Program
    {
        ...
        {
            string s = File.ReadAllText(@"D:\kbtu\principes of programing\c#\txt_files\2.txt");
            ...
            StreamWriter F1 = new StreamWriter(@"D:\kbtu\principes of programing\c#\txt_files\3.txt");
            for (int i = 0; i < n; i++)
            {
                 if (mas2[i] != 0)
                 {
